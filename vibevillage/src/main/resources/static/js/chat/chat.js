...
var sendChannel,
    receiveChannel,
    chatWindow = document.querySelector('.unique-chat-window'),
    chatWindowMessage = document.querySelector('.unique-chat-window-message'),
    chatThread = document.querySelector('.unique-chat-thread');
...
function handleMessage (event) {
    ...
    // Add message to unique chat thread and scroll to bottom
